...
class _LandingPageState extends State<LandingPage>
    with TickerProviderStateMixin, QrScanningMixin {
  ...
  // Duration calculation delegated to mixin

  // Duration formatting delegated to mixin
  ...
  // Error display delegated to mixin
  ...
  Widget _buildAttendanceStatusContent(
    ...
    bool isSmallScreen,
  ) => buildAttendanceStatusContent(snapshot, isSmallScreen);
