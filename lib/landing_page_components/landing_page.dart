...
class _AttendanceHistoryDialog extends StatefulWidget {
  ...
  @override
  State<_AttendanceHistoryDialog> createState() =>
      _AttendanceHistoryDialogState();
}

class _AttendanceHistoryDialogState extends State<_AttendanceHistoryDialog> {
    ...
    _records.sort((a, b) {
      ...
      switch (_sortColumnIndex) {
        ...
        case 3:
          ...
          break;
        default:
          cmp = compareNullableDate(a.date, b.date);
      }
