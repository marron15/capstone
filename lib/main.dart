...
import 'landing_page_components/equipment_images.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/customer-landing': (context) => const LoginChoicePage(),
        '/Home-Page': (context) => const LoginChoicePage(),
        '/admin-dashboard':
...
class _LoginChoicePageState extends State<LoginChoicePage>
  ...
  void _scrollToSection(String section) {
    ...
    switch (section) {
      case 'Home':
        ...
        return;
      case 'Service':
        targetKey = _equipmentKey;
        break;
      case 'Products':
        targetKey = _productsKey;
        break;
      case 'Inquiries':
        targetKey = _trainersKey;
        break;
      case 'About Us':
    ...
    if (targetKey?.currentContext != null) {
      ...
      // Account for the sticky header height (100px) so the title is visible
      const double headerOffset = 100.0;
      final double targetScroll =
          _scrollController.offset + offset - headerOffset;
      _scrollController.animateTo(
  ...
  void initState() {
    ...
    if (kIsWeb) {
      // PWA install handled by JavaScript in index.html
    }
  }
                                        ...
                                        unifiedAuthState.isCustomerLoggedIn
                                            ...
                                            : Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'At RNR Fitness Gym, we help you build strength, confidence, and discipline\n—one workout at a time.',
                                                  style: TextStyle(
                                                    fontSize:
                                                        MediaQuery.of(
                                                                  context,
